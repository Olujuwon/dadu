...
export declare class Firestore implements firestore.FirebaseFirestore, FirebaseService {
    ...
    INTERNAL: {
        ...
        drainAsyncQueue: (executeDelayedTasks: boolean) => Promise<void>;
    };
...
export declare class DocumentSnapshot implements firestore.DocumentSnapshot {
    ...
    private convertObject(data);
    private convertValue(value);
    private convertArray(data);
}
...
export declare class QuerySnapshot implements firestore.QuerySnapshot {
    ...
    readonly docs: firestore.DocumentSnapshot[];
    readonly empty: boolean;
    readonly size: number;
    forEach(callback: (result: firestore.DocumentSnapshot) => void, thisArg?: AnyJs): void;
